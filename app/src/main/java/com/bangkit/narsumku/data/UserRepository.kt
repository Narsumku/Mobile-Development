...
import com.bangkit.narsumku.data.response.ProfileResponse
...
class UserRepository private constructor(
    ...
    suspend fun getProfile(userId: String): Results<ProfileResponse> {
        return try {
    ...
    private fun handleHttpException(e: HttpException): Results.Error {
        val jsonInString = e.response()?.errorBody()?.string()
        val errorBody = Gson().fromJson(jsonInString, ErrorResponse::class.java)
